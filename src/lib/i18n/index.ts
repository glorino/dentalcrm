...
export const translations = {
  ...
  cta: {
    ...
    desc: { en: "Every ticket is a promise. DentalCRM makes sure you keep it.", fr: "Chaque ticket est une promesse. DentalCRM s'assure que vous la tenez." },
