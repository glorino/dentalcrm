      ...
      <header className="sticky top-0 z-30 h-[68px] border-b border-gray-200/50 bg-white/70 backdrop-blur-2xl">
        <div className="flex h-full items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => router.push('/dashboard/inbox')} className="h-10 w-10 rounded-xl hover:bg-gray-100/80 flex items-center justify-center text-gray-500 hover:text-gray-700 transition-all duration-200 relative">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
